...
public class SimpleWebServer_SSTest extends SimpleWebServer_SSTest_scaffolding {
  ...
  public void test_findIndexFileInDirectory_00()  throws Throwable  {
      ...
      Object object0 = PrivateAccess.callMethod((Class<SimpleWebServer>) SimpleWebServer.class, simpleWebServer0, "findIndexFileInDirectory", (Object) file0, (Class<?>) File.class);
  ...
  public void test_registerPluginForMimeType_01()  throws Throwable  {
      ...
      Object object0 = PrivateAccess.callMethod((Class<SimpleWebServer>) SimpleWebServer.class, simpleWebServer0, "registerPluginForMimeType", (Object) stringArray0, (Class<?>) String[].class, (Object) "", (Class<?>) String.class, (Object) webServerPlugin0, (Class<?>) WebServerPlugin.class, (Object) map0, (Class<?>) Map.class);
      assertNull(object0);
  }
  @Test(timeout = 4000)
  public void test_listDirectory_02()  throws Throwable  {
      ...
      Object object0 = PrivateAccess.callMethod((Class<SimpleWebServer>) SimpleWebServer.class, simpleWebServer0, "listDirectory", (Object) "Reques", (Class<?>) String.class, (Object) file0, (Class<?>) File.class);
      assertEquals("<html><head><title>Directory Reques</title><style><!--\nspan.dirname { font-weight: bold; }\nspan.filesize { font-size: 75%; }\n// -->\n</style></head><body><h1>Directory Reques</h1></body></html>", object0);
  }
  @Test(timeout = 4000)
  public void test_serveFile_03()  throws Throwable  {
      ...
      Response response0 = (Response)PrivateAccess.callMethod((Class<SimpleWebServer>) SimpleWebServer.class, simpleWebServer0, "serveFile", (Object) "-2080531653", (Class<?>) String.class, (Object) map0, (Class<?>) Map.class, (Object) file1, (Class<?>) File.class, (Object) " bytes", (Class<?>) String.class);
  ...
  public void test_serveFile_05()  throws Throwable  {
      ...
      Response response0 = (Response)PrivateAccess.callMethod((Class<SimpleWebServer>) SimpleWebServer.class, simpleWebServer0, "serveFile", (Object) "", (Class<?>) String.class, (Object) map0, (Class<?>) Map.class, (Object) file0, (Class<?>) File.class, (Object) "l]VAjhUao<U%d", (Class<?>) String.class);
  ...
  public void test_listDirectory_08()  throws Throwable  {
      ...
      Object object0 = PrivateAccess.callMethod((Class<SimpleWebServer>) SimpleWebServer.class, simpleWebServer0, "listDirectory", (Object) "", (Class<?>) String.class, (Object) file1, (Class<?>) File.class);
      assertNotNull(object0);
  }
  @Test(timeout = 4000)
  public void test_listDirectory_09()  throws Throwable  {
      ...
      Object object0 = PrivateAccess.callMethod((Class<SimpleWebServer>) SimpleWebServer.class, simpleWebServer0, "listDirectory", (Object) "SSL", (Class<?>) String.class, (Object) file0, (Class<?>) File.class);
      assertNotNull(object0);
  }
  @Test(timeout = 4000)
  public void test_listDirectory_10()  throws Throwable  {
      ...
      File file1 = mock(File.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn(stringArray0).when(file1).list(any(java.io.FilenameFilter.class));
      Object object0 = PrivateAccess.callMethod((Class<SimpleWebServer>) SimpleWebServer.class, simpleWebServer0, "listDirectory", (Object) "</section>", (Class<?>) String.class, (Object) file1, (Class<?>) File.class);
      assertNotNull(object0);
  }}
